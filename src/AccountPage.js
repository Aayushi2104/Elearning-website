...
import profile from './images/1667304983974.jpg';
const AccountPage = () => {
      ...
      <div className="bg-gray-800 p-16 rounded-xl shadow-lg w-11/12 max-w-7xl">
        ...
        <div className="flex items-center mb-12">
          <img
            ...
            alt="Profile"
            className="w-32 h-32 rounded-full mr-8 border-4 border-teal-400"
          />
          <div>
            <h1 className="text-4xl font-bold text-teal-400">{user.name}</h1>
        ...
        {/* Experience Section */}
        <div className="mb-12">
          <h2 className="text-3xl font-semibold text-teal-400 mb-6">Experience</h2>
        ...
        {/* Education Section */}
        <div className="mb-12">
          <h2 className="text-3xl font-semibold text-teal-400 mb-6">Education</h2>
          <div className="bg-gray-700 p-8 rounded-lg shadow-inner">
            {user.credentials.map((cred, index) => (
              <div key={index} className="mb-6">
                <h3 className="text-2xl font-semibold text-teal-300">{cred.title}</h3>
        ...
        <div>
          <h2 className="text-3xl font-semibold text-teal-400 mb-6">Purchased Courses</h2>
